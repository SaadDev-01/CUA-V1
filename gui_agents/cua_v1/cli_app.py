...
def main():
    parser = argparse.ArgumentParser(description="Run CUAV1 with specified model.")
    parser.add_argument(
        "--provider",
        type=str,
        default="openai",
    ...
    parser.add_argument(
        "--task",
        type=str,
        help="The task instruction for CUA-V1 to perform.",
    )
